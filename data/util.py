...
class DatasetSplit(Dataset):
    ...
    def __getitem__(self, item):
        return (item, *self.dataset[self.idxs[item]])
...
def get_dataset(dataset_tag, data_dir, dataset_split, transform_split, color = None):
    ...
    if dataset_tag == "CelebA":
        ...
        dataset = AttributeDataset(
            root=root, split=dataset_split, transform=transform, color=color
        )
