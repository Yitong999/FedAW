...
#             loss = loss_d_update.mean()
            ...
            if client == 1:
                ...
                print('*** loss_aligned: ', loss_per_sample_b[aligned_mask].mean())
                print('*** loss_skewed: ', loss_per_sample_b[skewed_mask].mean())
                
                if aligned_mask.any().item():
                    writer.add_scalar("loss_client_1/b_train_aligned", loss_per_sample_b[aligned_mask].mean(), local_epochs*epochs+step)

                if skewed_mask.any().item():
                    writer.add_scalar("loss_client_1/b_train_skewed", loss_per_sample_b[skewed_mask].mean(), local_epochs*epochs+step)
